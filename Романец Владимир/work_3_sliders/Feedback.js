...
Усложняем задачу =)) => Попробуй реализовать на одной странице 2 галереи одну толькос пагинацией,
а вторую только с кнопками (next / prev) естественно у каждойсво уникальный список картинок.
А самое главное все это с помощью одного конструктора =). (в конструктор обьектом передаються параметры галереи)
...
надеюсь тебе самому было интересно реализовать подобный плагин ))
